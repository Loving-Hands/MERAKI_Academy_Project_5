              ...
              <div className="uniqueAppointment-form-wrapper">
                <form onSubmit={handleSubmitForm}>
                  ...
                  <p className="text-capitalize fw-bold">
                    <FaClock style={{ paddingRight: "4px" }} />
                    clinic open between:{" "}
                    {doctor.open_days ? doctor.open_days.join(" / ") : ""}
                  </p>
                  <p className="text-capitalize fw-bold">
                    <FaCalendarDays style={{ paddingRight: "4px" }} /> clinic
                    Days Opening : {doctor.time_open} - {doctor.time_close}
                  </p>
